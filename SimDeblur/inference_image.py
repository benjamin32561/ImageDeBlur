...
def parse_arguments():
    """
    this whole projcet requieres GPU
    python inference_image.py --config_file ./configs/nafnet/nafnet_gopro.yaml --ckpt_file ./checkpoints/NAFNet/NAFNet_GoPro_width64_sim.pth --img ./datasets/images/00000050.png --save_path save_path
    """
